CREATE OR REPLACE FUNCTION public.calculate_time_cost_v2(profile_type text, edge_distance double precision, baseline_speed numeric, generalized_congestion text, source_elevation numeric, target_elevation numeric, pavement_quality character varying, road_type character varying, distance_param boolean, traffic_param boolean)
 RETURNS numeric
 LANGUAGE plpgsql
AS $function$
DECLARE
