CREATE OR REPLACE FUNCTION public.calculate_cost_advanced_v2(profile_type text, edge_distance double precision, time_cost numeric, road_type character varying, pm2_air_path_quality text, pm10_air_path_quality text, leisure character varying, amenity character varying, landuse character varying, natural_link character varying, tourism character varying, safe_param_active boolean, traffic_param boolean, distance_param boolean, air_pollution_param boolean, green_param boolean)
 RETURNS numeric
 LANGUAGE plpgsql
AS $function$
DECLARE
